...
public class AccountCreationPageTest extends BaseClass {
    ...
    public void verifyCreateAccountPageTest(String email) throws Throwable {
        startTestCase("verifyCreateAccountPageTest");
        ...
        endTestCase("verifyCreateAccountPageTest");
    }

    private void endTestCase(String verifyCreateAccountPageTest) {
    }

    private void startTestCase(String verifyCreateAccountPageTest) {
    }
    ...
    public void createAccountTest(HashMap<String,String> hashMapValue) throws Throwable {
        startTestCase("createAccountTest");
        indexPage= new IndexPage();
        loginPage=indexPage.clickOnSignIn();
